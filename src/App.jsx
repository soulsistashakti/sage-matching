  ...
  const getNudge = async (i, question, answer) => {
    ...
    try {
      ...
      const text = await callSage(
        ...
        return `You are the voice of Sage — a plant-based matchmaking platform built on slowness and intention. ${context}\n\n"${question}"\n\nTheir answer: "${answer}"\n\n${journeyInstruction}\n\nTell them a tiny parable — 2-3 sentences. A real-feeling moment about a real-feeling person that mirrors something in what they wrote, informed by everything they have shared. No analysis. No advice. No "you". Just a small story that lands quietly and opens something. Like Khalil Gibran, not a life coach. End with a concrete image, not an abstract conclusion. Do not repeat the same metaphor, setting, or image used in any previous parable in this conversation. Each parable must evolve — always moving outward into new territory. IMPORTANT: Only use details the person has actually written in this conversation. Do not invent or assume biographical details, locations, or circumstances not mentioned in their answers. ${cliffhangerInstruction} CLIFFHANGER STRUCTURE: If this is the final question of a stone, the story must stop at the moment of maximum tension — before the resolution, not after it. The very last line of the story should be the moment just before something happens. Then on a new line add the closing sentence. The reader must be left wanting to know what happens next, not feeling satisfied.`;
      })(),
        300
      );
