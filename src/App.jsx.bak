...
/* SHARED */
.divider{height:1px;background:linear-gradient(90deg,transparent,rgba(229,221,208,.08),transparent);margin:0 48px;}
.sec{padding:90px 48px;}
.sec-ey{font-size:10px;letter-spacing:.24em;text-transform:uppercase;color:#3A1A10;opacity:.6;margin-bottom:18px;font-family:'Nunito',sans-serif;font-weight:800;}
.sec-h{font-family:'Cormorant Garamond',serif;font-size:clamp(32px,4vw,54px);font-weight:300;color:#3A1A10;line-height:1.06;}
.sec-h em{font-style:italic;color:#3A1A10;}
...
.btn-ghost{background:none;color:#3A1A10;border:1px solid rgba(229,221,208,.18);padding:13px 26px;border-radius:1px;font-family:'Nunito',sans-serif;font-size:11px;letter-spacing:.12em;text-transform:uppercase;cursor:pointer;transition:all .25s;font-weight:700;}
.btn-ghost:hover{color:#3A1A10;border-color:#3A1A10;}
...
.eyebrow{font-size:10px;letter-spacing:0.26em;text-transform:uppercase;color:#3A1A10;opacity:.65;margin-bottom:28px;display:flex;align-items:center;gap:14px;font-family:'Nunito',sans-serif;font-weight:800;}
.eyebrow::before{content:'';display:block;width:28px;height:1px;background:#D4847A;opacity:.5;}
...
h1.hero-h em{font-style:italic;color:#3A1A10;}
...
.hero-phil{font-family:'Cormorant Garamond',serif;font-style:italic;font-size:22px;color:#3A1A10;margin-bottom:46px;}
...
.fc-tag{font-size:9px;padding:2px 7px;border:1px solid rgba(212,132,122,.2);border-radius:1px;color:#3A1A10;letter-spacing:.05em;}

/* MANIFESTO */
.manifesto{padding:72px 48px;background:linear-gradient(135deg,rgba(212,132,122,.3) 0%,transparent 100%);border-top:1px solid rgba(212,132,122,.07);border-bottom:1px solid rgba(212,132,122,.07);}
...
.m-attr{font-size:11px;letter-spacing:.14em;text-transform:uppercase;color:#3A1A10;}
...
.tier-features li::before{content:'—';color:#3A1A10;font-size:10px;flex-shrink:0;margin-top:2px;}
...
.step-n{font-family:'Cormorant Garamond',serif;font-size:56px;font-weight:300;color:#3A1A10;line-height:1;margin-bottom:18px;}
.step-t{font-family:'Cormorant Garamond',serif;font-size:20px;color:#3A1A10;margin-bottom:10px;font-weight:400;}
...
.card-bg{position:absolute;width:326px;height:504px;left:7px;top:8px;background:rgba(255,255,255,.012);border:1px solid rgba(212,132,122,.05);border-radius:12px;}
.pcard{position:absolute;inset:0;background:linear-gradient(155deg,rgba(28,64,40,.92) 0%,rgba(9,22,14,.97) 100%);border:1px solid rgba(212,132,122,.16);border-radius:12px;padding:40px 34px;display:flex;flex-direction:column;text-align:left;transition:transform .38s cubic-bezier(.4,0,.2,1),opacity .38s;user-select:none;}
...
.demo-hint{font-size:11px;color:#3A1A10;letter-spacing:.08em;text-align:center;}
...
.gp-h1 em{font-style:italic;color:#3A1A10;}
.gp-sub{font-size:14px;line-height:1.9;color:#3A1A10;max-width:480px;margin-bottom:14px;font-weight:300;}
.gp-phil{font-family:'Cormorant Garamond',serif;font-style:italic;font-size:14px;color:#3A1A10;}
...
.gp-prog-label{font-size:10px;letter-spacing:.12em;text-transform:uppercase;color:#3A1A10;white-space:nowrap;font-family:'Nunito',sans-serif;font-weight:800;}
...
function StoneDetail({ stone, isComplete, isUnlocked, onComplete, onClose, asSheet, email }) {
  ...
  const getFallbackNudge = (i, answer) => {
    ...
    const affirmResponses = [
      ...
      `What you love has its own kind of logic. "${word}" isn't random — it says something about how you move through the world. The right person will recognize it immediately.`,
      `The fact that you answered "${word}" says something important — not what you do, but who you are when no one is asking you to be anything in particular.`,
    ...
    <div className="sage-root">
      ...
      {tab === "home" && <>
        <section className="hero">
          ...
          <div className="hero-content">
            ...
            <h1 className="hero-h">Bloom<br/><em>in your own time.</em></h1>
        ...
        <section className="sec">
          ...
          <p style={{fontSize:15,lineHeight:1.88,color:"#3A1A10",maxWidth:560,marginTop:18,fontFamily:"'Nunito',sans-serif",fontWeight:500}}>
            Small, intimate workshops that deepen the Garden Path work. Led by Sage founder Brenda Brewer — mindfulness teacher, relationship coach, and the person who built this platform from the ground up. Each workshop is a room where the real work happens.
          </p>
      ...
      {tab === "demo" && (
        <section className="sec" style={{minHeight:"82vh",display:"flex",flexDirection:"column",alignItems:"center",textAlign:"center"}}>
          ...
          <p style={{fontSize:14,lineHeight:1.82,color:"rgba(229,221,208,.43)",maxWidth:400,fontWeight:300}}>These profiles are from members who have completed at least two stones of the Garden Path.</p>
